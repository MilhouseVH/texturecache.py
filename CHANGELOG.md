...
##Version 1.7.7 (02/10/2014)
* Add: Support for `@clean.showdialogs` and `@scan.showdialogs`, default `no`. With JSON API 6.18.2, JSON initiated library scans and cleans will not show any GUI progress or dialogs. Enable GUI progress/dialogs by setting these new parameters to `yes`.
